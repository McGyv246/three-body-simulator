 ...
 */
int velverlet_ndim_npart(const double dt, const double forceConst, const int nBodies, const int spatialDim, 
const double *masses, double *coord, double *vel, double *force, double **f_o, void (*F)(double *, double *, double, int, double *))
{
    /*
    Codice di test:
    double dt = 0.001;
